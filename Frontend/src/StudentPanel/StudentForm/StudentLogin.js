  ...
  return (
    <div>
      ...
      <div className="new-wrapper bbwar">
        <h1 className='Signup1'>Sign in as a Student</h1>
          ...
          <div className='Loginformj'>
            ...
            <Form className='Loginformj1' >
              ...
              <Form.Group className="mb-4  " controlId="formBasicname">
                ...
                <Link  className='ForgetPassword mb-5' to='/ForgetPassword'>Forget Password ?</Link>
...
<br></br><br></br>
              ...
              <Link to="/StudentSignup" className='notres1' style={{ alignItems: "center", textAlign: "center" }}>Sign Up</Link>
              </Stack>
