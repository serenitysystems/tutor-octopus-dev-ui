  ...
  return (
    <div>
      ...
      <div className="new-wrapper bbwar">
        <h1 className='Signup1'>Sign up as a Student</h1>
        ...
        <section id="advertisers" className="advertisers-service-sec pt-5 pb-5  mb-5" style={{
          ...
          <div className='Loginformj'>
            ...
            <h1 className='Signup24 mb-5'>Let’s get started!</h1>
              ...
              <Button className='VOIR_LESPRODUITSbn991 ' type="submit">Create My Student Account</Button>
