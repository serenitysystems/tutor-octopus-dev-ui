...
import {
  AddStudentWithoutBatch,
  getStudentReadBatch,
  getStudentWithoutBatch,
...
const Student = ({ userData }) => {
  ...
  const handleSavebatch = async () => {
    ...
    if (getbatchname.length === 0) {
      ...
      setbatchName((prevBatchName) => [
        ...prevBatchName,
        batchvalue.current.value,
      ]); // Update batchName array

      // Now that batchName has been updated, stringify it
      let sessionBatch = JSON.stringify([
        ...batchName,
        batchvalue.current.value,
      ]);
      ...
      <div class="container-fluid">
        <div class="row">
          <nav class="col-md-3 d-none d-md-block bg-light sidebar">
            <Sidenavbar sideBarOptions={constants.TUTOROPTIONS} />
          </nav>
            ...
            <div class="dashboard-header px-md-4">
              ...
              <Modal show={show} onHide={handleClose} animation={false}>
                <Modal.Header closeButton>
                  <Modal.Title>
                    <h5>Add Students under a new batch</h5>
                  </Modal.Title>
                </Modal.Header>
                <Modal.Body>
