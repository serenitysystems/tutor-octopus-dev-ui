  ...
  const onSubmit = async () => {
    ...
    if (Object.keys(errors).length === 0 && !optionError) {
      ...
      if (data.activeQuiz._id) {
        const payload = {
          ...newFormData,
          quizId: location.pathname.split("/ExamFeatures/")[1],
        };
        console.log(payload,"............updatedQuiz")
        ...
        const payload = {
          ...
          quizType: location.pathname.substring(
        ...
        <div className="d-flex gap-2 flex-column">
                  <div className="d-flex gap-2 flex-column">
                    <div className="d-flex align-items-center mb-2 gap-2">
                     ...
                     && data.activeQuiz.quizType!='Practice')
                     &&
                     <div>
                    ...
                    <Description
                      ...
                      register={register}
                      quizType={data?.activeQuiz?.quizType}
                                 ...
                                 {formDatanew?.questions[questionIndex]
                                  .questionType === "Fill" &&
                                   ...
                                   <div>
                                     ...
                                     placeholder="answer"
                                     style={{ width: "100px" }}
                                     id={`question-${questionIndex}.correctOption[${0}]`}
                                     {...register(
                                      `questions.${questionIndex}.correctOption.${0}`,
                                      {
                                        required:
                                  ...
                                  .questionType === "Short" &&
                                   ...
                                   <div>
                                     <Form.Control
                                    placeholder="add important key words for answer"
                                    // style={{ width: "100px" }}
                                    id={`question-${questionIndex}.correctOption[${0}]`}
                                    {...register(
                                     `questions.${questionIndex}.correctOption.${0}`,
