      ...
      <div>
        {["lg"].map((expand) => (
          <Navbar
            key={expand}
            expand={expand}
            className=" navbarf fixed-top desktop11"
          >
            <Container fluid>
              <Navbar.Brand>
                <Link to="/">
        ...
        <Navbar
          bg="white"
          expand="md"
          className="fixed-top navu9 desktop22"
          style={{ height: "90px", color: "black" }}
        >
          <Container>
            <Link
              to="/"
              className="text-decoration-none  mx-3"
              style={{ fontSize: "34px", fontFamily: "Italic" }}
            >
            ...
            <Navbar.Collapse id="basic-navbar-nav text-white bn">
              <Nav className="me-auto nav-links">
                ...
                <Link className="navlink2" to="#Programes">
                  Programes{" "}
                </Link>
                <Link className="navlink2" to="/">
                  Our Tutors{" "}
